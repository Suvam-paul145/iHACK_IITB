  ...
  return (
    <section id="let'splay" className="items-center flex flex-col px-36 bg-hotline">
      <div className="font-display flex text-white flex-col text-center items-center gap-4 my-[251px]">
        ...
        <h2 className="text-white">Join us in the realm of gaming where every click opens up a world of adventure <br /> and discovery. Let&apos;s Play isn&apos;t just a destination; it&apos;s a gateway to boundless <br /> entertainment</h2>
